...
var _GridField3 = __webpack_require__("./client/src/components/GridField/React/GridField.js");

var _GridField4 = _interopRequireDefault(_GridField3);
...
exports.default = function () {
  _Injector2.default.component.registerMany({
    ...
    ReactGridField: _GridField4.default
  });
};
...
/***/ "./client/src/components/GridField/React/GridField.js":
/***/ (function(module, exports, __webpack_require__) {
...
var GridField = function (_React$Component) {
  _inherits(GridField, _React$Component);
  ...
  function GridField(props) {
    ...
    _this.state = {
      variables: _this.props.data.graphqlVariables
    };
    _this.updateVariables = _this.updateVariables.bind(_this);
    _this._query = (0, _graphqlTag2.default)(_this.props.data.graphqlQuery);
    return _this;
  }
  ...
  _createClass(GridField, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps.data.graphqlQuery !== this.props.query) {
        this._query = (0, _graphqlTag2.default)(nextProps.data.graphqlQuery);
      }
    }
  }, {
    key: 'updateVariables',
    value: function updateVariables(variables) {
      this.setState({
        variables: _extends({}, this.state.variables, variables)
      });
    }
  }, {
    key: 'renderComponent',
    value: function renderComponent(component, gridFieldProps) {
      var extraProps = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

      var Component = this.context.injector.get(component.name);

      return _react2.default.createElement(Component, _extends({ gridField: gridFieldProps, data: component.data }, extraProps));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        _reactApollo.Query,
        { query: this._query, variables: this.state.variables },
        function (graphql) {
          ...
          if (!queryResult) return _react2.default.createElement(
            'h3',
            null,
            'Loading...'
          );
          ...
          var gridFieldProps = {
            ...
            queryName: queryName,
            QUERY: _this2._query,
            updateVariables: _this2.updateVariables
          };

          var beforeComponents = components.filter(function (c) {
            return c.position === 'before';
          });
          var afterComponents = components.filter(function (c) {
            return c.position === 'after';
          });
          var headerComponents = components.filter(function (c) {
            return c.position === 'header';
          });
          var rowComponents = components.filter(function (c) {
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              beforeComponents.map(function (component) {
                return _react2.default.createElement(
                  'div',
                  { key: component.name },
                  _this2.renderComponent(component, gridFieldProps)
                );
              })
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'tr',
                  null,
                  headerComponents.map(function (component) {
                    return _react2.default.createElement(
                      'th',
                      { key: component.name },
                      _this2.renderComponent(component, gridFieldProps)
                  ...
                  rowComponents.map(function (component) {
                    return _react2.default.createElement('th', { key: component.name });
                  })
                )
              ),
              _react2.default.createElement(
                'tbody',
                null,
                queryResult.edges.map(function (_ref) {
                  var node = _ref.node;

                  var entries = Object.entries(node);
                  var key = entries.reduce(function (acc, curr) {
                  ...
                  return _react2.default.createElement(
                    ...
                    entries.map(function (entry) {
                      ...
                      return _react2.default.createElement(
                        'td',
                        { style: { padding: '4px', border: '1px solid' }, key: column + '-' + value },
                        value
                      );
                    }),
                    rowComponents.map(function (component) {
                      return _react2.default.createElement(
                        'td',
                        { key: component.name },
                        _this2.renderComponent(component, gridFieldProps, { node: node })
                      );
                    })
                  );
                })
            ...
            _react2.default.createElement(
              ...
              afterComponents.map(function (component) {
                return _react2.default.createElement(
                  'div',
                  { key: component.name },
                  _this2.renderComponent(component, gridFieldProps)
...
exports.default = (0, _redux.compose)(_FieldHolder2.default, _Injector.withInjector)(GridField);
