...
var _useBeforeUnload = __webpack_require__("./node_modules/history/lib/useBeforeUnload.js");
...
var _ReactRouteRegister = __webpack_require__(41);
...
var _apolloClient = __webpack_require__(24);
...
var _GridField = __webpack_require__(36);

var _GridField2 = _interopRequireDefault(_GridField);

var _ReactGridField = __webpack_require__("./client/src/components/GridField/ReactGridField.js");

var _ReactGridField2 = _interopRequireDefault(_ReactGridField);

var _GridFieldHeaderComponentSlot = __webpack_require__("./client/src/components/GridField/GridFieldHeaderComponentSlot.js");

var _GridFieldHeaderComponentSlot2 = _interopRequireDefault(_GridFieldHeaderComponentSlot);

var _GridFieldComponentSlot = __webpack_require__("./client/src/components/GridField/GridFieldComponentSlot.js");

var _GridFieldComponentSlot2 = _interopRequireDefault(_GridFieldComponentSlot);
...
var _LiteralField = __webpack_require__(37);
...
var _FormBuilderModal = __webpack_require__(27);
...
var _ViewModeToggle = __webpack_require__(50);
...
var _SearchToggle = __webpack_require__(48);
...
exports.default = function () {
  _Injector2.default.component.registerMany({
    ...
    ReactGridField: _ReactGridField2.default,
    GridFieldBeforeComponents: _GridFieldComponentSlot2.default,
    GridFieldAfterComponents: _GridFieldComponentSlot2.default,
    GridFieldHeaderComponents: _GridFieldHeaderComponentSlot2.default
  });
};
  ...
  _createClass(ActionMenu, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          restProps = _objectWithoutProperties(_props, ['dropdownToggleProps', 'dropdownMenuProps']);

      var className = this.props.className;

      className = (0, _classnames2.default)('action-menu', className);

      var toggleClassName = (0, _classnames2.default)('action-menu__toggle', 'btn', 'btn--icon-xl', 'btn--no-text', 'font-icon-dot-3', dropdownToggleProps.className);
...
var CheckboxWithHolder = function CheckboxWithHolder(props) {
  var FieldHolder = (0, _FieldHolder2.default)(CheckboxField);

  return _react2.default.createElement(FieldHolder, _extends({}, props, { hideLabels: true }));
};

exports.Component = CheckboxField;
exports.default = CheckboxWithHolder;
...
var _modernizr = __webpack_require__(15);
...
var DateField = function (_TextField) {
  ...
  _createClass(DateField, [{
    ...
    value: function getInputProps() {
      ...
      var defaultValue = this.asHTML5() ? this.props.value : this.getLocalisedValue();
...
DateField.propTypes = {
  ...
  modernizr: _react2.default.PropTypes.object,
  data: _react2.default.PropTypes.shape({
    html5: _react2.default.PropTypes.bool
  })
};
...
/***/ "./client/src/components/GridField/GridFieldComponentSlot.js":
/***/ (function(module, exports, __webpack_require__) {
...
var GridFieldComponentSlot = function GridFieldComponentSlot(_ref) {
  var components = _ref.components;
  return _react2.default.createElement(
    'div',
    null,
    components.map(function (Component, i) {
      return _react2.default.createElement(Component, { key: i });
    })
  );
};
...
exports.default = GridFieldComponentSlot;
...
/***/ "./client/src/components/GridField/GridFieldHeaderComponentSlot.js":
/***/ (function(module, exports, __webpack_require__) {
...
var GridFieldHeaderComponentSlot = function GridFieldHeaderComponentSlot(_ref) {
  var components = _ref.components;
  return _react2.default.createElement(
    'thead',
    null,
...
exports.default = GridFieldHeaderComponentSlot;
...
/***/ "./client/src/components/GridField/ReactGridField.js":
/***/ (function(module, exports, __webpack_require__) {
...
var ReactGridField = function (_React$Component) {
  _inherits(ReactGridField, _React$Component);

  function ReactGridField() {
    _classCallCheck(this, ReactGridField);

    return _possibleConstructorReturn(this, (ReactGridField.__proto__ || Object.getPrototypeOf(ReactGridField)).apply(this, arguments));
  }

  _createClass(ReactGridField, [{
    key: 'render',
    value: function render() {
      var _this2 = this;
              ...
              _react2.default.createElement(
                ...
                !loading && queryResult && queryResult.edges.map(function (_ref3) {
                  ...
                  return _react2.default.createElement(
                    ...
                    Object.values(node).map(function (col) {
                      return _react2.default.createElement(
                        'td',
                        { style: { padding: '4px', border: '1px solid' }, key: col },
                        col
                      );
                    })
                  );
...
ReactGridField.propTypes = {
  beforeComponents: _react2.default.PropTypes.array,
  afterComponents: _react2.default.PropTypes.array,
  headerComponents: _react2.default.PropTypes.array
};

exports.default = (0, _redux.compose)(_FieldHolder2.default, _Injector.withInjector)(ReactGridField);
  ...
  _createClass(GridFieldActions, [{
    ...
    value: function renderMultipleActions(schema) {
      ...
      return _react2.default.createElement(
        ...
        Object.keys(groupedActions).map(function (group, index) {
          return [index !== 0 && _react2.default.createElement(_reactstrap.DropdownItem, { divider: true }), groupedActions[group].map(function (action) {
...
actionShape.group = _react2.default.PropTypes.string;

GridFieldActions.propTypes = _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.shape(actionShape)).isRequired;
...
GridFieldDropdownAction.propTypes = {
  ...
  type: _react2.default.PropTypes.oneOf(['submit', 'link']),
...
var SearchBox = function (_Component) {
  ...
  _createClass(SearchBox, [{
    ...
    value: function renderClearButton() {
      ...
      return _react2.default.createElement(
        _reactstrap.Button,
        {
          ...
          title: _i18n2.default._t('Admin.CLEAR', 'Clear')
        },
        _i18n2.default._t('Admin.CLEAR', 'Clear')
      );
    }
  }, {
    ...
    value: function renderFilterButton() {
      ...
      var classes = (0, _classnames2.default)('btn--icon-md', 'btn--no-text', 'font-icon-caret-down-two', 'search-box__filter-trigger', { collapsed: !expanded });
    ...
    value: function render() {
      var _props5 = this.props,
          ...
          id = _props5.id,
          hideable = _props5.hideable,
          expanded = _props5.expanded,
          showFilters = _props5.showFilters,
          dirty = _props5.dirty,
      ...
      var showClear = !showEnter && clearable;
...
SearchBox.propTypes = {
  ...
  onToggleFilter: _react.PropTypes.func,
  ...
  hideable: _react.PropTypes.bool,
  showFilters: _react.PropTypes.bool,
  name: _react.PropTypes.string,
...
var SearchForm = function SearchForm(_ref) {
  var expanded = _ref.expanded,
      ...
      formSchemaUrl = _ref.formSchemaUrl,
      id = _ref.id,
...
SearchForm.propTypes = {
  ...
  id: _react.PropTypes.string.isRequired,
  formSchemaUrl: _react.PropTypes.string,
...
var toggleBtnClasses = function toggleBtnClasses(toggled) {
  return (0, _classnames2.default)('btn--no-text', 'search-toggle', 'font-icon-search', 'btn--icon-large', { 'search-toggle__active': toggled });
};
...
TabItem.contextTypes = {
  activeTabId: _react2.default.PropTypes.string
};
...
var Tabs = function (_Component) {
  ...
  function Tabs(props) {
    ...
    _this.state = {
      activeTab: _this.getDefaultActiveKey()
    };
    return _this;
  }
...
UsedOnTable.propTypes = {
  loading: _react.PropTypes.bool,
  usedOn: _react.PropTypes.arrayOf(_react.PropTypes.shape({
    id: _react.PropTypes.string,
    title: _react.PropTypes.string,
    type: _react.PropTypes.string,
...
var provideUsedOnData = function provideUsedOnData(UsedOnTable) {
  ...
  UsedOnDataProvider.propTypes = {
    ...
    loading: _react.PropTypes.bool,
    data: _react.PropTypes.oneOfType([_react.PropTypes.array, _react.PropTypes.shape({
      recordClass: _react.PropTypes.string,
      recordId: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]),
      readUsageEndpoint: _react.PropTypes.shape({
        url: _react.PropTypes.string,
        method: _react.PropTypes.string
      })
    })]),
    usedOn: _react.PropTypes.array
  };
...
var ApolloGraphqlManager = function () {
  ...
  _createClass(ApolloGraphqlManager, [{
    ...
    value: function addParam(name, value) {
      return this.addParams(_defineProperty({}, name, value));
    }
  }, {
    key: 'addParams',
    ...
    value: function addFields() {
      ...
      var existing = this.config.fields;
      this.config.fields = [].concat(_toConsumableArray(existing), _toConsumableArray(fields));
    ...
    value: function reduceApolloConfig(prev, key) {
      ...
      var calculateValue = function calculateValue(oldValue, transform) {
        ...
        return _this.coallesceData(key, oldValue, newValue);
      };
    ...
    key: 'getContainer',
    value: function getContainer() {
      return (0, _reactApollo.graphql)(this.getGraphqlAST(), this.getApolloConfig());
    }
  }]);
    ...
    value: function getMatchesForContext() {
      ...
      if (!this._contextCache[context]) {
        ...
        this._contextCache[context] = this._middlewares.filter(function (middleware) {
          return middleware.context[0] === GLOBAL_CONTEXT || middleware.context.every(function (part) {
            return part === WILDCARD || requestedContext.includes(part);
          });
        });
      }
...
var buildInjectorContainer = function buildInjectorContainer() {
  return {
    ...
    ready: function ready(callback) {
      ...
      this.callbacks = [].concat(_toConsumableArray(this.callbacks), [{ callback: callback, priority: priority }]);
    }
  };
};
...
var buildReadQuery = function buildReadQuery() {
  var tag = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _tags.defaultTag;
  return tag(_templateObject, _helpers.getPluralName, _helpers.getVariables, _helpers.getPluralName, _helpers.getParams, _helpers.getFields, _helpers.getFragments);
};
...
var getParams = exports.getParams = function getParams(_ref6) {
  ...
  var paramList = Object.keys(items).map(function (key) {
    return key + ': $' + key;
  });
...
var getFields = exports.getFields = function getFields(_ref7) {
  var fields = _ref7.fields,
      _ref7$pagination = _ref7.pagination,
      pagination = _ref7$pagination === undefined ? true : _ref7$pagination;

  var strings = fields.map(function (field) {
    return Array.isArray(field) ? '{ ' + getFields({ fields: field, pagination: false }) + ' }' : field;
  });
...
var getFragments = exports.getFragments = function getFragments(_ref8) {
  var availableFragments = _ref8.availableFragments,
      _ref8$fragments = _ref8.fragments,
      fragments = _ref8$fragments === undefined ? [] : _ref8$fragments;
  return Object.entries(availableFragments).reduce(function (capturedFragments, _ref9) {
      ...
      _createClass(GraphqlInjector, [{
        ...
        value: function componentWillMount() {
          ...
          _Container2.default.ready(function () {
            ...
            var target = null;
            try {
              var graphql = _this2.context.injector.query(key, context);
...
var _deepFreezeStrict = __webpack_require__(10);
...
var _reduxFieldReducer = __webpack_require__(51);
    ...
    case _ViewModeActionTypes2.default.SPLIT_AVAILABLE:
      {
        ...
        if (activeState === _ViewModeStates.VIEW_MODE_STATES.SPLIT && !splitAvailable) {
          activeState = _ViewModeStates.VIEW_MODE_STATES.EDIT;
        }
...
var _Backend = __webpack_require__(25);
...
var _RecordsActions = __webpack_require__(44);
...
Preview.propTypes = {
  ...
  ViewModeComponent: _react.PropTypes.oneOfType([_react.PropTypes.node, _react.PropTypes.func])
};
...
var _SchemaActions = __webpack_require__(20);
...
var Search = function (_Component) {
  ...
  function Search(props) {
    ...
    var term = props.term || props.filters && props.filters[props.name] || '';
    _this.state = {
  ...
  _createClass(Search, [{
    ...
    value: function focusFirstFormField() {
      ...
      var input = form.querySelector('input, textarea, select, button');
      if (input) {
        input.focus();
        if (input.select) {
          input.select();
    ...
    value: function render() {
      var _props = this.props,
          ...
          forceFilters = _props.forceFilters,
          id = _props.id,
          displayBehavior = _props.displayBehavior,
          identifier = _props.identifier,
          formIsDirty = _props.formIsDirty,
          props = _objectWithoutProperties(_props, ['formSchemaUrl', 'forceFilters', 'id', 'displayBehavior', 'identifier', 'formIsDirty']);
...
Search.propTypes = {
  ...
  id: _react.PropTypes.string.isRequired,
  display: _react.PropTypes.oneOf(Object.values(DISPLAY)),
  formSchemaUrl: _react.PropTypes.string,
  filters: _react.PropTypes.object,
  formData: _react.PropTypes.object,
  placeholder: _react.PropTypes.string,
  displayBehavior: _react.PropTypes.oneOf(Object.values(BEHAVIOR)),
  term: _react.PropTypes.string,
  name: _react.PropTypes.string,
  forceFilters: _react.PropTypes.bool,
  formIsDirty: _react.PropTypes.bool,
  identifier: _react.PropTypes.string,
  schemaName: _react.PropTypes.string
};
...
function mapStateToProps(state, ownProps) {
  ...
  return { formData: formData, formIsDirty: formIsDirty, schemaName: schemaName };
}
...
var _ViewModeActions = __webpack_require__(49);
...
ViewModeToggle.propTypes = {
  activeState: _react.PropTypes.oneOf(Object.values(_ViewModeStates.VIEW_MODE_STATES)),
  area: _react.PropTypes.string.isRequired,
  splitAvailable: _react.PropTypes.bool,
  onPreviewSelect: _react.PropTypes.func,
  onEditSelect: _react.PropTypes.func,
  onSplitSelect: _react.PropTypes.func,
  editIconClass: _react.PropTypes.string,
  previewIconClass: _react.PropTypes.string,
  splitIconClass: _react.PropTypes.string
};
...
FormBuilderLoader.propTypes = Object.assign({}, _FormBuilder.basePropTypes, {
  ...
  loadingComponent: _react.PropTypes.oneOfType([_react.PropTypes.func, _react.PropTypes.node]).isRequired
});
